...
export const ScraperIcon: React.FC<IconProps> = ({ className = "w-5 h-5", title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.358 0 2.662-.31 3.759-.872m-7.518 0A9.006 9.006 0 0112 3c1.358 0 2.662.31 3.759.872m-7.518 0V4.5c0-.621.504-1.125 1.125-1.125h4.25c.621 0 1.125.504 1.125 1.125V5.25m-7.518 0A9.006 9.006 0 0012 21c2.274 0 4.34-.848 5.863-2.233" />
    </svg>
);
